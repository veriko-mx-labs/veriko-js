/**
 * Pruebas sobre `spec/openapi.yaml`.
 *
 * El spec de este repositorio es copia del de https://docs.veriko.mx/openapi.yaml. Estas
 * pruebas fallan si la copia no cumple el contrato de esa API.
 *
