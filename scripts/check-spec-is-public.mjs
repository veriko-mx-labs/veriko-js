 ...
 *
 * El 2026-09-18, el primer endpoint que publicó el spec sirvió el bundle crudo,
 * con las 264 rutas `/admin/*` y sus schemas. La copia de este repositorio sale
 * de https://docs.veriko.mx/openapi.yaml, que ya está filtrada por
 * `x-visibility`, y de ahí salen los tipos generados.
 *
